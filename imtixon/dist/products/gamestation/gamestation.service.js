...
exports.GameStationService = void 0;
...
let GameStationService = class GameStationService {
    repo;
    brandRepo;
    categoryRepo;
    ...
    async findOne(id) {
        ...
        if (!product)
            throw new common_1.NotFoundException('Game Station topilmadi');
        return product;
    }
    async update(id, dto) {
        const product = await this.repo.findOne({ where: { id } });
...
exports.GameStationService = GameStationService;
exports.GameStationService = GameStationService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(product_entity_1.GameStationProduct)),
...
//# sourceMappingURL=gamestation.service.js.map