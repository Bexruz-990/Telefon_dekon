...
exports.SmartphoneProductService = void 0;
...
let SmartphoneProductService = class SmartphoneProductService {
    repo;
    brandRepo;
    categoryRepo;
    ...
    async findOne(id) {
        ...
        if (!product)
            throw new common_1.NotFoundException('Smartfon topilmadi');
        return product;
    }
    async update(id, dto) {
        const product = await this.repo.findOne({ where: { id } });
...
exports.SmartphoneProductService = SmartphoneProductService;
exports.SmartphoneProductService = SmartphoneProductService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(product_entity_1.SmartphoneProduct)),
    __param(1, (0, typeorm_1.InjectRepository)(brand_entity_1.Brand)),
    __param(2, (0, typeorm_1.InjectRepository)(category_entity_1.Category)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        typeorm_2.Repository,
        typeorm_2.Repository])
], SmartphoneProductService);
